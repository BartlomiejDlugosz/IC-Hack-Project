...
info_template = "{title: '', info: '', type: ''}"

question_template = "{question: '', options: ['', '', '', ''], correct_answer: '', type: ''}"

def create_section(interest, concept):    
    try:
        section = askGPT(f"""You are an expert teacher specializing in making complex concepts easy to understand using real-life analogies.
